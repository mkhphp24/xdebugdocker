...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\AdminHomePageController' => 'getAdminHomePageControllerService',
    ...
    /**
     * Gets the public 'App\Controller\AdminHomePageController' shared autowired service.
     *
     * @return \App\Controller\AdminHomePageController
     */
    protected function getAdminHomePageControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/AdminHomePageController.php';

        $this->services['App\\Controller\\AdminHomePageController'] = $instance = new \App\Controller\AdminHomePageController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\AdminHomePageController', $this));
    ...
    /**
     * Gets the private '.service_locator.d1lfUNR' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_D1lfUNRService()
    {
        return $this->privates['.service_locator.d1lfUNR'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\AdminHomePageController::index' => ['privates', '.service_locator.SOGscYu', 'get_ServiceLocator_SOGscYuService', false],
            'App\\Controller\\HomeController::index' => ['privates', '.service_locator.SOGscYu', 'get_ServiceLocator_SOGscYuService', false],
            'App\\Controller\\SecurityController::login' => ['privates', '.service_locator.g.xob4v', 'get_ServiceLocator_G_Xob4vService', false],
            'App\\Controller\\AdminHomePageController:index' => ['privates', '.service_locator.SOGscYu', 'get_ServiceLocator_SOGscYuService', false],
            'App\\Controller\\HomeController:index' => ['privates', '.service_locator.SOGscYu', 'get_ServiceLocator_SOGscYuService', false],
            'App\\Controller\\SecurityController:login' => ['privates', '.service_locator.g.xob4v', 'get_ServiceLocator_G_Xob4vService', false],
        ], [
            'App\\Controller\\AdminHomePageController::index' => '?',
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.d1lfUNR'] ?? $this->get_ServiceLocator_D1lfUNRService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/(post|comment)/\\d+$'), [0 => 'ROLE_USER'], NULL);
    ...
    protected function getSecurity_Authentication_Listener_Form_MainService()
    {
        ...
        $b->setOptions(['login_path' => 'login', 'default_target_path' => 'admin_home_page', 'always_use_default_target_path' => true, 'target_path_parameter' => '_target_path', 'use_referer' => false]);
